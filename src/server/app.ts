...
import syncDemandRoutes from './routes/sync-demand.routes.js';
import syncDemandAdminRoutes from './routes/sync-demand-admin.routes.js';
import userTemplateRoutes from './routes/user-template.routes.js';
...
app.use('/api/sync-demands', syncDemandRoutes);
app.use('/api/admin/sync-demands', syncDemandAdminRoutes);
