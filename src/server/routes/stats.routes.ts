...
import { getOverviewStats, getTimeSeriesAgg, getOverviewDuurzaamheid } from '../controllers/stats.controller.js';
...
router.get('/overview/duurzaamheid', authenticate, getOverviewDuurzaamheid);
